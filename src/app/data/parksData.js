export const parksData = [
  {
    ...
    name: "Taman Suropati",
    category: "Taman Kota",
    bio: "Taman ikonik dengan pepohonan besar, komunitas musik, dan suasana sore yang adem untuk nongkrong santai.",
    location: "Menteng",
  ...
  },
  {
    ...
    name: "Taman Menteng",
    category: "Taman Kota",
    bio: "Ruang modern dengan rumah kaca, lapangan olahraga, dan area terbuka luas; sangat ramai terutama saat akhir pekan.",
    location: "Menteng",
    image: "/icon/tamanmenteng.svg"
  },
  {
    id: 3,
    name: "Taman Lapangan Banteng",
    category: "Taman Kota",
    bio: "Taman megah dengan air mancur menari, monumen bersejarah, dan jalur jogging; sangat fotogenik pada malam hari.",
    location: "Gambir",
  ...
  },
  {
    ...
    name: "Hutan Kota GBK",
    category: "Hutan Kota",
    bio: "Hutan kota populer dengan pepohonan tinggi, trek sepeda, dan spot piknik—paru-paru hijau kawasan pusat kota.",
    location: "Gelora (Tanah Abang)",
    image: "/icon/hutankotagbk.svg"
  },
  {
    id: 5,
    name: "Taman Ismail Marzuki (TIM)",
    category: "Taman Tematik",
    bio: "Taman budaya dengan teater terbuka, galeri seni, dan panggung musik; pusat kegiatan kreatif dan festival seni.",
    location: "Cikini (Menteng)",
    image: "/icon/tamanismailmarzuki.svg"
  },
  {
    id: 6,
    name: "Taman Monas",
    category: "Taman Tematik",
    bio: "Taman sejarah luas dengan relief perjuangan, area jogging, dan suasana malam penuh cahaya; ikon wisata warga Jakarta.",
    location: "Gambir",
  ...
  },
  {
    ...
    location: "Matraman (batas Jakarta Pusat)",
